    ...
    return (
      <div className="bg-white">
        <div className="mx-auto max-w-7xl mt-5 lg:px-8">
          <div className="relative isolate overflow-hidden  justify-center bg-grey-500 px-6 py-6 text-center shadow-2xl rounded-2xl sm:rounded-2xl sm:px-16">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                ...
                href={link}
                className="rounded-md bg-custom-yellow px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-custom-dark-yellow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
               {button}
              </a>
            </div>
